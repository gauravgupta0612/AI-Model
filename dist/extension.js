...
function activate(context) {
    ...
    async function performAISearch(sourceCode) {
        try {
            const response = await axios_1.default.post('http://localhost:5000/search', { sourceCode });
...
const followRedirects = __webpack_require__(68);
